...
엔드 투 엔드(end-to-end) RNA-seq 차등 발현 분석 파이프라인**을 구현하는 것을 목표로 합니다.

---

## 프로젝트 개요 (Overview)

이 프로젝트는 **장수와 관련된 특정 유전자 변이가 간암 세포의 유전자 발현 패턴에 어떤 영향을 미치는지**를  
...
각 조건마다 **3개의 생물학적 반복 샘플**이 포함되어 있으며,  
총 **18개의 RNA-seq 샘플**로 구성되어 있습니다.
...
- 장수인에서 발견된 SIRT6 변이가  
  **암의 공격성 및 침습성과 관련된 유전자 발현을 억제하는지**를 분석
